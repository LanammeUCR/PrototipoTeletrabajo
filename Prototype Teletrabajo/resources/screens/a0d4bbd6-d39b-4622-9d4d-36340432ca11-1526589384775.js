jQuery("#simulation")
  .on("click", ".s-a0d4bbd6-d39b-4622-9d4d-36340432ca11 .click", function(event, data) {
  ...
  .on("pageload", ".s-a0d4bbd6-d39b-4622-9d4d-36340432ca11 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Menu_Bar")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Menu_item_1","#s-solicitud_teletrabajo" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Menu_item_2","#s-Menu_item_1","#s-solicitud_teletrabajo" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Menu_item_2","#s-Menu_item_1","#s-Menu_item_3","#s-solicitud_teletrabajo" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Menu_item_2","#s-Menu_item_1","#s-Menu_item_3","#s-Menu_item_6","#s-solicitud_teletrabajo" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
