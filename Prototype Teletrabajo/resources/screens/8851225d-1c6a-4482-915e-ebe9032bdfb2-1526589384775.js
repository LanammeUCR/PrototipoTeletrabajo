jQuery("#simulation")
  .on("click", ".s-8851225d-1c6a-4482-915e-ebe9032bdfb2 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Menu_item_1")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/2de62f6b-3eba-497a-a039-dc6749c11c90"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
